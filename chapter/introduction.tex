...
website \linklsdnasc{lsdnasc.byu.edu} will get a new page to be accessible from the 
...
on the BYU Life Science IT web server, and a new database or \linkglobusindex{``search index''} 
hosted by Globus.
